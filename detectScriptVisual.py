...
label = label_file.readlines()[350:500]
...
for _ in range(0,len(no)):
    ...
    ret = dt.detect_licese("pic\\" + x +".jpg",location[int(_)][0],
                           vertical_coe=14, square_range=(0.007, 0.21),enhance=True,
                           hwRate=(1.2,10), height_range=(0.28, 0.91),enhance_speed=2.2,
                           itercoe=6,anit_verical_coe=6,range_coe = 1.15,showImg=True)
    if len(ret) == 0:
        err3 = err3 + 1
        err1 = err1 + 1
        continue
